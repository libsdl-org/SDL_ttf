...
typedef enum
{
  ...
  TTF_SCRIPT_BOPOMOFO,
  TTF_SCRIPT_BRAILLE,
  TTF_SCRIPT_CANADIAN_SYLLABICS,
  TTF_SCRIPT_CHEROKEE,
  TTF_SCRIPT_ETHIOPIC,
  TTF_SCRIPT_KHMER,
  TTF_SCRIPT_MONGOLIAN,
  TTF_SCRIPT_MYANMAR,
  TTF_SCRIPT_OGHAM,
  TTF_SCRIPT_RUNIC,
  TTF_SCRIPT_SINHALA,
  ...
  TTF_SCRIPT_BUGINESE,
  TTF_SCRIPT_COPTIC,
  TTF_SCRIPT_GLAGOLITIC,
  TTF_SCRIPT_KHAROSHTHI,
  TTF_SCRIPT_NEW_TAI_LUE,
  TTF_SCRIPT_OLD_PERSIAN,
  TTF_SCRIPT_SYLOTI_NAGRI,
  TTF_SCRIPT_TIFINAGH,

  TTF_SCRIPT_BALINESE,
  TTF_SCRIPT_CUNEIFORM,
  TTF_SCRIPT_NKO,
  TTF_SCRIPT_PHAGS_PA,
  TTF_SCRIPT_PHOENICIAN,
  ...
  TTF_SCRIPT_OL_CHIKI,
  TTF_SCRIPT_REJANG,
  TTF_SCRIPT_SAURASHTRA,
  TTF_SCRIPT_SUNDANESE,
  TTF_SCRIPT_VAI,

  TTF_SCRIPT_AVESTAN,
  TTF_SCRIPT_BAMUM,
  TTF_SCRIPT_EGYPTIAN_HIEROGLYPHS,
  TTF_SCRIPT_IMPERIAL_ARAMAIC,
  TTF_SCRIPT_INSCRIPTIONAL_PAHLAVI,
  TTF_SCRIPT_INSCRIPTIONAL_PARTHIAN,
  TTF_SCRIPT_JAVANESE,
  TTF_SCRIPT_KAITHI,
  TTF_SCRIPT_LISU,
  TTF_SCRIPT_MEETEI_MAYEK,
  TTF_SCRIPT_OLD_SOUTH_ARABIAN,
  TTF_SCRIPT_OLD_TURKIC,
  TTF_SCRIPT_SAMARITAN,
  TTF_SCRIPT_TAI_THAM,
  TTF_SCRIPT_TAI_VIET,
  ...
  TTF_SCRIPT_CHAKMA,
  TTF_SCRIPT_MEROITIC_CURSIVE,
  TTF_SCRIPT_MEROITIC_HIEROGLYPHS,
  TTF_SCRIPT_MIAO,
  TTF_SCRIPT_SHARADA,
  TTF_SCRIPT_SORA_SOMPENG,
  TTF_SCRIPT_TAKRI,

  /*
   * Since HarfBuzz: 0.9.30
   */
  TTF_SCRIPT_BASSA_VAH,
  TTF_SCRIPT_CAUCASIAN_ALBANIAN,
  TTF_SCRIPT_DUPLOYAN,
  TTF_SCRIPT_ELBASAN,
  TTF_SCRIPT_GRANTHA,
  TTF_SCRIPT_KHOJKI,
  TTF_SCRIPT_KHUDAWADI,
  TTF_SCRIPT_LINEAR_A,
  TTF_SCRIPT_MAHAJANI,
  TTF_SCRIPT_MANICHAEAN,
  TTF_SCRIPT_MENDE_KIKAKUI,
  TTF_SCRIPT_MODI,
  TTF_SCRIPT_MRO,
  TTF_SCRIPT_NABATAEAN,
  TTF_SCRIPT_OLD_NORTH_ARABIAN,
  TTF_SCRIPT_OLD_PERMIC,
  TTF_SCRIPT_PAHAWH_HMONG,
  TTF_SCRIPT_PALMYRENE,
  TTF_SCRIPT_PAU_CIN_HAU,
  TTF_SCRIPT_PSALTER_PAHLAVI,
  TTF_SCRIPT_SIDDHAM,
  TTF_SCRIPT_TIRHUTA,
  TTF_SCRIPT_WARANG_CITI,

  TTF_SCRIPT_AHOM,
  TTF_SCRIPT_ANATOLIAN_HIEROGLYPHS,
  TTF_SCRIPT_HATRAN,
  TTF_SCRIPT_MULTANI,
  TTF_SCRIPT_OLD_HUNGARIAN,
  TTF_SCRIPT_SIGNWRITING,

  /*
   * Since HarfBuzz 1.3.0
   */
  TTF_SCRIPT_ADLAM,
  TTF_SCRIPT_BHAIKSUKI,
  TTF_SCRIPT_MARCHEN,
  TTF_SCRIPT_OSAGE,
  TTF_SCRIPT_TANGUT,
  TTF_SCRIPT_NEWA,
   ...
   */
  TTF_SCRIPT_MASARAM_GONDI,
  TTF_SCRIPT_NUSHU,
  TTF_SCRIPT_SOYOMBO,
  TTF_SCRIPT_ZANABAZAR_SQUARE,

  /*
   * Since HarfBuzz 1.8.0
   */
  TTF_SCRIPT_DOGRA,
  TTF_SCRIPT_GUNJALA_GONDI,
  TTF_SCRIPT_HANIFI_ROHINGYA,
  TTF_SCRIPT_MAKASAR,
  TTF_SCRIPT_MEDEFAIDRIN,
  TTF_SCRIPT_OLD_SOGDIAN,
  TTF_SCRIPT_SOGDIAN,
   ...
   */
  TTF_SCRIPT_ELYMAIC,
  TTF_SCRIPT_NANDINAGARI,
  TTF_SCRIPT_NYIAKENG_PUACHUE_HMONG,
  TTF_SCRIPT_WANCHO,

  /*
   * Since HarfBuzz 2.6.7
   */
  TTF_SCRIPT_CHORASMIAN,
  TTF_SCRIPT_DIVES_AKURU,
  TTF_SCRIPT_KHITAN_SMALL_SCRIPT,
  TTF_SCRIPT_YEZIDI,
...
/* Set Direction and Script to be used for text shaping.
   ...
   Deprecated. Prefer TTF_SetFontDirection() and TTF_SetFontScriptName()
*/
